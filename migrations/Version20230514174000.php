 ...
 */
final class Version20230514174000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, visiteur_name VARCHAR(255) NOT NULL, visiteur_email VARCHAR(255) NOT NULL, visiteur_nb_convive INT NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', heure DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', visiteur_allergene LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
